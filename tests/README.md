...
### [`strToFragment(htmlStr)`](/../src/js/helpers/DOMUtils.js#L4-L14)
...
### injectSumProductsQuantity(selectors)
...
### `order({ firstName, lastName, address, city, email }, productsIds)`
...
## `controllers/orderConfirmedController.js`
